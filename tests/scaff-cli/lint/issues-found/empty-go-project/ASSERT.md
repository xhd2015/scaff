...
- Output does **not** mention opt-in fix rules (`script/generate`, `git/hooks`, `github/release`, `install/via-curl`, `script/github/release-assets`).
...
func Assert(t *testing.T, req *Request, resp *Response, err error) {
	...
	for _, omit := range []string{"script/generate", "git/hooks", "github/release", "install/via-curl", "script/github/release-assets"} {
