...
- Output reports would-create for `AGENTS.md`.
...
func Assert(t *testing.T, req *Request, resp *Response, err error) {
	...
	if fileExists(t, req, "AGENTS.md") {
		t.Fatal("AGENTS.md should not be created in dry-run")
	}
	...
	if !strings.Contains(out, "agents") {
		t.Fatalf("expected AGENTS.md path hint in preview, got:\n%s", resp.Combined)
	}
}
```