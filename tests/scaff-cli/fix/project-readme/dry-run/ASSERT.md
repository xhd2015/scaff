...
- Output reports would-create for `README.md`.
...
func Assert(t *testing.T, req *Request, resp *Response, err error) {
	...
	if fileExists(t, req, "README.md") {
		t.Fatal("README.md should not be created in dry-run")
	}
	...
	if !strings.Contains(out, "readme") {
		t.Fatalf("expected README path hint in preview, got:\n%s", resp.Combined)
	}
}
```